// app/categories/accessories/page.js
'use client'
...
export default function AccessoriesPage() {
  ...
  const mockProducts = [
    {
      id: 1, name: "DESIGNER HANDBAG", price: "₹12,499", originalPrice: "₹18,999", 
      image: "/products/accessories/handbag.jpg", category: "bags", brand: "Gucci", 
      condition: "Excellent", rating: 4.9, isBestseller: true, isVerified: true
    },
    {
      id: 2, name: "SUNGLASSES", price: "₹4,999", originalPrice: "₹7,999", 
      image: "/products/accessories/sunglasses.jpg", category: "eyewear", brand: "Ray-Ban", 
      condition: "Like New", rating: 4.7, isBestseller: true, isVerified: true
    },
    {
      id: 3, name: "SILVER NECKLACE", price: "₹2,499", originalPrice: "₹3,999", 
      image: "/products/accessories/necklace.jpg", category: "jewelry", brand: "Tanishq", 
      condition: "Excellent", rating: 4.6, isBestseller: false, isVerified: true
    },
    {
      id: 4, name: "LEATHER WALLET", price: "₹1,299", originalPrice: "₹1,999", 
      image: "/products/accessories/wallet.jpg", category: "bags", brand: "Hidesign", 
      condition: "Good", rating: 4.4, isBestseller: false, isVerified: true
    },
    {
      id: 5, name: "DESIGNER BELT", price: "₹1,799", originalPrice: "₹2,499", 
      image: "/products/accessories/belt.jpg", category: "other", brand: "Armani", 
      condition: "Like New", rating: 4.5, isBestseller: true, isVerified: true
    },
    {
      id: 6, name: "PERFUME SET", price: "₹3,499", originalPrice: "₹5,999", 
      image: "/products/accessories/perfume.jpg", category: "other", brand: "Dior", 
  ...
  const categories = [
    { id: 'all', name: 'All Items', count: 38 },
    { id: 'bags', name: 'Bags', count: 12 },
    { id: 'jewelry', name: 'Jewelry', count: 10 },
    { id: 'eyewear', name: 'Eyewear', count: 8 },
    { id: 'other', name: 'Other', count: 8 }
  ]

  const brands = ['Gucci', 'Ray-Ban', 'Tanishq', 'Hidesign', 'Armani', 'Dior', 'All']
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] sm:h-[75vh] md:h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/categories/accessories-banner.jpg"
              alt="Accessories - Just Becho"
              fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center text-white px-4 sm:px-6">
              ...
              <p className="text-xl sm:text-2xl font-light tracking-widest uppercase opacity-90 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
                ...
                Complete your look with pre-loved luxury accessories
              </p>
          ...
          <div className="max-w-[1700px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-gray-900 text-3xl sm:text-4xl font-light tracking-widest uppercase mb-4">
                WHY SHOP ACCESSORIES AT JUST BECHO
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Every accessory verified by our experts
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Only genuine pre-loved luxury accessories
                </p>
              </div>
