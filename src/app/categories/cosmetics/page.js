// app/categories/cosmetics/page.js
'use client'
...
export default function CosmeticsPage() {
  ...
  const mockProducts = [
    {
      id: 1, name: "MAC LIPSTICK SET", price: "₹2,499", originalPrice: "₹3,999", 
      image: "/products/cosmetics/mac.jpg", category: "makeup", brand: "MAC", 
      condition: "Brand New", rating: 4.8, isBestseller: true, isVerified: true
    },
    {
      id: 2, name: "CHANEL PERFUME", price: "₹6,999", originalPrice: "₹9,999", 
      image: "/products/cosmetics/chanel.jpg", category: "perfumes", brand: "Chanel", 
      condition: "Like New", rating: 4.9, isBestseller: true, isVerified: true
    },
    {
      id: 3, name: "L'OREAL FOUNDATION", price: "₹1,299", originalPrice: "₹1,999", 
      image: "/products/cosmetics/loreal.jpg", category: "makeup", brand: "L'Oreal", 
      condition: "Excellent", rating: 4.5, isBestseller: false, isVerified: true
    },
    {
      id: 4, name: "LAKME EYESHADOW", price: "₹899", originalPrice: "₹1,499", 
      image: "/products/cosmetics/lakme.jpg", category: "makeup", brand: "Lakme", 
      condition: "Good", rating: 4.3, isBestseller: false, isVerified: true
    },
    {
      id: 5, name: "DIOR SKINCARE", price: "₹3,499", originalPrice: "₹5,999", 
      image: "/products/cosmetics/dior.jpg", category: "skincare", brand: "Dior", 
      condition: "Like New", rating: 4.7, isBestseller: true, isVerified: true
    },
    {
      id: 6, name: "BODY SHOP PERFUME", price: "₹1,799", originalPrice: "₹2,499", 
      image: "/products/cosmetics/bodyshop.jpg", category: "perfumes", brand: "The Body Shop", 
  ...
  const categories = [
    { id: 'all', name: 'All Items', count: 35 },
    { id: 'makeup', name: 'Makeup', count: 15 },
    { id: 'skincare', name: 'Skincare', count: 12 },
    { id: 'perfumes', name: 'Perfumes', count: 8 }
  ]

  const brands = ['MAC', 'Chanel', 'L\'Oreal', 'Lakme', 'Dior', 'The Body Shop', 'All']
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] sm:h-[75vh] md:h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/categories/cosmetics-banner.jpg"
              alt="Cosmetics & Perfume - Just Becho"
              fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center text-white px-4 sm:px-6">
              ...
              <p className="text-xl sm:text-2xl font-light tracking-widest uppercase opacity-90 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
                ...
                Beauty products and fragrances, lovingly pre-owned
              </p>
          ...
          <div className="max-w-[1700px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-gray-900 text-3xl sm:text-4xl font-light tracking-widest uppercase mb-4">
                WHY SHOP COSMETICS AT JUST BECHO
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Only genuine pre-loved beauty products
                </p>
              </div>
