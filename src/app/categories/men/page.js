...
export default function MensFashionPage() {
  ...
  const categories = [
    ...
    { id: 'shirts', name: 'Shirts', count: 8 },
    { id: 'jeans', name: 'Jeans', count: 10 },
    { id: 'jackets', name: 'Jackets', count: 6 },
    { id: 'suits', name: 'Suits', count: 4 },
    { id: 'footwear', name: 'Footwear', count: 9 },
    { id: 'accessories', name: 'Accessories', count: 7 }
  ]

  const brands = [
    'Nike', 'Adidas', 'Zara', 'H&M', 'Levi\'s', 'Puma', 'Raymond', 'Fossil', 'All'
  ]
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] sm:h-[75vh] md:h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/categories/men-banner.jpg"  // Change this to your men's fashion banner image
              alt="Men's Fashion - Just Becho"
              fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center text-white px-4 sm:px-6">
              ...
              <p className="text-xl sm:text-2xl font-light tracking-widest uppercase opacity-90 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
                ...
                Discover pre-loved luxury fashion for men
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Every men's fashion item verified by our luxury experts
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Only genuine pre-loved luxury men's fashion
                </p>
              </div>
