...
export default function WomensFashionPage() {
  ...
  const mockProducts = [
    {
      id: 1, name: "DESIGNER SUMMER DRESS", price: "₹8,499", originalPrice: "₹12,999", 
      image: "/products/women/dress.jpg", category: "dresses", brand: "H&M", 
      condition: "Excellent", rating: 4.7, isBestseller: true, isVerified: true
    },
    {
      id: 2, name: "DESIGNER HANDBAG", price: "₹15,499", originalPrice: "₹22,999", 
      image: "/products/women/handbag.jpg", category: "accessories", brand: "Zara", 
      condition: "Like New", rating: 4.9, isBestseller: true, isVerified: true
    },
    {
      id: 3, name: "CASUAL TOP", price: "₹1,299", originalPrice: "₹2,499", 
      image: "/products/women/top.jpg", category: "tops", brand: "H&M", 
      condition: "Good", rating: 4.2, isBestseller: false, isVerified: true
    },
    {
      id: 4, name: "DESIGNER KURTI", price: "₹2,199", originalPrice: "₹3,999", 
      image: "/products/women/kurti.jpg", category: "ethnic", brand: "FabIndia", 
      condition: "Excellent", rating: 4.5, isBestseller: false, isVerified: true
    },
    {
      id: 5, name: "HIGH HEELS", price: "₹3,499", originalPrice: "₹5,999", 
      image: "/products/women/heels.jpg", category: "footwear", brand: "Mochi", 
      condition: "Like New", rating: 4.6, isBestseller: true, isVerified: true
    },
    {
      id: 6, name: "DESIGNER SAREE", price: "₹4,999", originalPrice: "₹8,999", 
      image: "/products/women/saree.jpg", category: "ethnic", brand: "Sabyasachi", 
      condition: "Excellent", rating: 4.8, isBestseller: false, isVerified: true
    }
  ]
  ...
  const categories = [
    ...
    { id: 'dresses', name: 'Dresses', count: 15 },
    { id: 'tops', name: 'Tops', count: 12 },
    { id: 'jeans', name: 'Jeans', count: 8 },
    { id: 'skirts', name: 'Skirts', count: 5 },
    { id: 'ethnic', name: 'Ethnic Wear', count: 10 },
    { id: 'footwear', name: 'Footwear', count: 7 },
    { id: 'accessories', name: 'Accessories', count: 11 }
  ]

  const brands = ['Zara', 'H&M', 'Mango', 'Forever 21', 'Nike', 'Adidas', 'All']
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] sm:h-[75vh] md:h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/categories/women-banner.jpg"
              alt="Women's Fashion - Just Becho"
              fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center text-white px-4 sm:px-6">
              ...
              <p className="text-xl sm:text-2xl font-light tracking-widest uppercase opacity-90 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
                ...
                Explore curated pre-loved luxury for women
              </p>
          ...
          <div className="max-w-[1700px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-gray-900 text-3xl sm:text-4xl font-light tracking-widest uppercase mb-4">
                WHY SHOP WOMEN'S FASHION AT JUST BECHO
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Every women's fashion item verified by our experts
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Only genuine pre-loved luxury women's fashion
                </p>
              </div>
