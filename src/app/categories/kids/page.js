...
export default function KidsFashionPage() {
  ...
  const mockProducts = [
    {
      id: 1, name: "BOYS T-SHIRT PACK", price: "₹1,499", originalPrice: "₹2,499", 
      image: "/products/kids/tshirt.jpg", category: "boys", brand: "H&M Kids", 
      condition: "Excellent", rating: 4.5, isBestseller: true, isVerified: true
    },
    {
      id: 2, name: "GIRLS SUMMER DRESS", price: "₹2,199", originalPrice: "₹3,499", 
      image: "/products/kids/dress.jpg", category: "girls", brand: "Zara Kids", 
      condition: "Like New", rating: 4.7, isBestseller: true, isVerified: true
    },
    {
      id: 3, name: "INFANT ONESIES SET", price: "₹899", originalPrice: "₹1,499", 
      image: "/products/kids/onesies.jpg", category: "infants", brand: "Carter's", 
      condition: "Good", rating: 4.3, isBestseller: false, isVerified: true
    },
    {
      id: 4, name: "SCHOOL SHOES", price: "₹1,299", originalPrice: "₹1,999", 
      image: "/products/kids/shoes.jpg", category: "footwear", brand: "Bata", 
      condition: "Excellent", rating: 4.6, isBestseller: false, isVerified: true
    },
    {
      id: 5, name: "EDUCATIONAL TOYS", price: "₹1,599", originalPrice: "₹2,499", 
      image: "/products/kids/toys.jpg", category: "toys", brand: "Lego", 
      condition: "Like New", rating: 4.8, isBestseller: true, isVerified: true
    },
    {
      id: 6, name: "WINTER JACKET", price: "₹1,799", originalPrice: "₹2,999", 
      image: "/products/kids/jacket.jpg", category: "boys", brand: "Gap Kids", 
  ...
  const categories = [
    ...
    { id: 'boys', name: 'Boys Wear', count: 12 },
    { id: 'girls', name: 'Girls Wear', count: 14 },
    { id: 'infants', name: 'Infants', count: 6 },
    { id: 'footwear', name: 'Footwear', count: 8 },
    { id: 'toys', name: 'Toys', count: 10 }
  ]

  const brands = ['H&M Kids', 'Zara Kids', 'Gap Kids', 'Carter\'s', 'Lego', 'All']
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] sm:h-[75vh] md:h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/categories/kids-banner.jpg"
              alt="Kids Fashion - Just Becho"
              fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center text-white px-4 sm:px-6">
              ...
              <p className="text-xl sm:text-2xl font-light tracking-widest uppercase opacity-90 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
                ...
                Adorable pre-loved fashion for kids
              </p>
          ...
          <div className="max-w-[1700px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-gray-900 text-3xl sm:text-4xl font-light tracking-widest uppercase mb-4">
                WHY SHOP KIDS FASHION AT JUST BECHO
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Every kids item verified for safety and quality standards
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Only gently used kids fashion items in perfect condition
                </p>
              </div>
