// app/categories/watches/page.js
'use client'
...
export default function WatchesPage() {
  ...
  const mockProducts = [
    {
      id: 1, name: "ROLEX SUBMARINER", price: "₹89,999", originalPrice: "₹1,49,999", 
      image: "/products/watches/rolex.jpg", category: "luxury", brand: "Rolex", 
      condition: "Excellent", rating: 4.9, isBestseller: true, isVerified: true
    },
    {
      id: 2, name: "OMEGA SEAMASTER", price: "₹45,999", originalPrice: "₹79,999", 
      image: "/products/watches/omega.jpg", category: "luxury", brand: "Omega", 
      condition: "Like New", rating: 4.8, isBestseller: true, isVerified: true
    },
    {
      id: 3, name: "FOSSIL CHRONOGRAPH", price: "₹8,499", originalPrice: "₹12,999", 
      image: "/products/watches/fossil.jpg", category: "casual", brand: "Fossil", 
      condition: "Excellent", rating: 4.6, isBestseller: false, isVerified: true
    },
    {
      id: 4, name: "CASIO G-SHOCK", price: "₹4,999", originalPrice: "₹6,999", 
      image: "/products/watches/gshock.jpg", category: "sports", brand: "Casio", 
      condition: "Good", rating: 4.5, isBestseller: true, isVerified: true
    },
    {
      id: 5, name: "APPLE WATCH SERIES", price: "₹18,999", originalPrice: "₹29,999", 
      image: "/products/watches/apple.jpg", category: "smart", brand: "Apple", 
      condition: "Like New", rating: 4.7, isBestseller: false, isVerified: true
    },
    {
      id: 6, name: "TITAN RAGA", price: "₹5,499", originalPrice: "₹8,999", 
      image: "/products/watches/titan.jpg", category: "casual", brand: "Titan", 
  ...
  const categories = [
    ...
    { id: 'casual', name: 'Casual', count: 10 },
    { id: 'smart', name: 'Smart', count: 4 }
  ]

  const brands = ['Rolex', 'Omega', 'Fossil', 'Casio', 'Apple', 'Titan', 'All']
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-[60vh] sm:h-[75vh] md:h-[85vh] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/categories/watches-banner.jpg"
              alt="Watches - Just Becho"
              fill
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center text-white px-4 sm:px-6">
              ...
              <p className="text-xl sm:text-2xl font-light tracking-widest uppercase opacity-90 max-w-2xl mx-auto opacity-0 animate-fade-in-up"
                ...
                Timeless pre-loved luxury timepieces
              </p>
          ...
          <div className="max-w-[1700px] mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-gray-900 text-3xl sm:text-4xl font-light tracking-widest uppercase mb-4">
                WHY SHOP WATCHES AT JUST BECHO
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Every watch verified by horology experts
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Only genuine pre-loved luxury watches
                </p>
              </div>
